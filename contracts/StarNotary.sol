...
contract StarNotary is ERC721 {
    ...
    string public name = "Andrew's Star Token";
    ...
    */
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        bool verifyResult = (msg.sender==ownerAddress2||msg.sender==ownerAddress1);
        require(verifyResult, "You need to be the owner of one of the exchanging stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender==ownerOf(_tokenId),"You need to be the owner of tokenID");
